...
Route::middleware(['isAdmin'])->group(function () {
    Route::post('/addstudent', [App\Http\Controllers\StudentController::class, 'store'])->name('admin.addstudent');
    Route::get('/show', [App\Http\Controllers\StudentController::class, 'index'])->name('admin.show_student');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/check/{id}', [App\Http\Controllers\FrontEndController::class, 'check_finsh_Exam'])->name('checkk');
