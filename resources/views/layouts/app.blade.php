                    ...
                    <div class="row">
                        <div class="col-12">
                            <nav class="main-nav">
                                <!-- ***** Logo Start ***** -->
                                <a href="/" class="logo">
                                    إختبار تطبيق ويب باستخدام Laravel Php 
                                </a>
                                <!-- ***** Logo End ***** -->
                                <!-- ***** Menu Start ***** -->
                                <ul class="nav">
                                    ...
                                    @if (Route::has('login'))
                                        @auth
                                            <li><a href="{{ url('/home') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">الصفحة الرئيسية</a></li>
                                        @endauth
                                    @endif
                                    <li class="{{ Route::is('/view-exam') ? 'active' : '' }}"><a href="{{ route('viewExam') }}">الدخول لنظام الأمتحان</a></li>
                                    <!-- <li class="has-sub">
                                    ...
                                    <li>
                                        @if (Route::has('login'))
                                                ...
                                                @else
                                                    <a href="{{ route('login') }}" class="text-sm text-gray-700 dark:text-gray-500 underline" style="width:80px;float:left;">تسجيل الدخول</a>
