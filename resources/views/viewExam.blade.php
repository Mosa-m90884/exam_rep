...
<!-- <section>
    <div class="conatainer py-5">
        ...
        <i class="fa fa-hand-o-right" style="font-size:36px">
        </i> &nbsp; <a href="{{ route('joinExam',$res->id) }}">{{ $res->subject }}</a></h3>
        </div>
        @endforeach
    </div>
</section> -->
  ...
  <div class="d-flex justify-content-center">
        ...
        <div class="d-flex justify-content-center">
          ...
          <tbody>
              ...
              <tr>
                ...
                <td>30 Minutes</td>
                <td>
                  <a href="{{ route('checkk',$row->id) }}" class="btn btn-primary">Join Exam</a>
                </td>
              </tr>
              @endforeach
          </tbody>
    ...
    <div class="footer bg-dark" style="margin-top:0px;">
      <p>Copyright © 2022 Engineer Masters Solutions. All Rights Reserved.
          <br>Design: <a href="#" target="_parent" title="free css templates">Mousa Mahmoud</a></p>
    </div>
